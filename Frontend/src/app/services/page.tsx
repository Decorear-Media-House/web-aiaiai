...
export default async function ServicesPage() {
  ...
  const robotics: any = {
    ...
    check_items: textareaToArray(m.svc_robotics_check_items),
  ...
  const security: any = {
    ...
    check_items: textareaToArray(m.svc_security_check_items),
  ...
  const ai_solution: any = {
    ...
    outcomes_enabled: textareaToArray(m.svc_ai_solution_outcomes_enabled),
    use_case_categories: textareaToArray(m.svc_ai_solution_use_case_categories),
